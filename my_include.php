<?php
class clsmy_include { //my_include class @1-FD1741DE
...
//Class_Initialize Event @1-938DE4E8
    function clsmy_include($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "my_include.php";
        $this->Redirect = "";
        $this->TemplateFileName = "my_include.html";
...
} //End my_include Class @1-FCB6E20C
