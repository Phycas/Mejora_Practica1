...
//Connection Settings @0-0F847AE1
...
//Initialize Common Variables @0-19887E43
...
//cosas Connection Class @-FE24FCFA
class clsDBcosas extends DB_Adapter
{
    function clsDBcosas()
    {
        $this->Initialize();
    ...
    function Initialize()
    {
        ...
        $this->SetProvider($CCConnectionSettings["cosas"]);
        parent::Initialize();
