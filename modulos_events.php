...
//Page_BeforeInitialize @1-1C25407C
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $modulos; //Compatibility
//End Page_BeforeInitialize

//Panel1UpdatePanel1 PageBeforeInitialize @42-B4F71FC5
...
//Page_AfterInitialize @1-0588E0AA
